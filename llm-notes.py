...
files_to_merge = ['Trade.h','DataProcessor.cpp', 'DataProcessor.h', 'DataProcessor.h', 'PerformanceAssessor.cpp', 'PerformanceAssessor.h','PriceData.h','SlidingWindow.h','TechnicalIndicators.cpp','TechnicalIndicators.h','TradingKLX.cpp','TradingKLX.h', 'TradingSignal.h','TradingStrategy.cpp','TradingStrategy.h']
