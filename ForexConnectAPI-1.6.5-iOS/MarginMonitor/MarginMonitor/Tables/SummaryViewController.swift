...
class SummaryTableRow
{
    ...
    init(offerId: String, instrument: String, amount: String, mmr: String, grossPL: String) {
...
class SummaryTable : IO2GTableListener, IO2GEachRowListener
{
    ...
    private func addSummary(row: IO2GSummaryTableRow) {
        ...
        let mmr = row.getUsedMargin().parseToPlaces(places: 2)
        
        let tableRow: SummaryTableRow = SummaryTableRow(offerId: offerId!, instrument: instrument!, amount: amount, mmr: mmr, grossPL: grossPL)
...
class SummaryViewController : UITableViewController
{
    ...
    override func viewDidLoad() {
        ...
        headerLabel.text = "    Symbol        Amount        MMR       GrossPL "
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let mmr = summaryTableRows[indexPath.row].mmr
